...
internal class CafeWoedroeIncFactory : CoffeeFactory
{
    internal override Beverage MakeCoffee(CoffeeType type)
    {
        ...
        switch (type)
        {
            ...
            default:
                throw new ArgumentException("Wat neoem jij mij nouw????");
        }
    }
}
